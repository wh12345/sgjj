...
(function () {
    ...
    x.K.sj = function (a, b) {
        ...
        d = a.style[b];
        if (!d)
            var e = c.GB[b], d = a.currentStyle || (x.da.la ? a.style : getComputedStyle(a, p)), d = e && e.get ? e.get(a, d) : d[e || b];
        if (e = c.Ol)
            d = e.filter(b, d, "get");
        return d
    };
    ...
    x.XK = function () {
        ...
        a.prototype = {
            ...
            move: function (a) {
                ...
                if (10 < Math.abs((this.zk ? a.touches[0].clientX : a.clientX) - this.iu) || 10 < Math.abs(c - this.ju))
                    this.oh = o
            },
            end: function (a) {
                na(a);
    ...
    x.extend(Ka.prototype, {
        ...
        oa: u("Jb"),
        vz: function () {
            for (var a = this.R.cF; a < z.Gr.length; a++)
                z.Gr[a](this);
            this.R.cF = a
        },
        sF: function (a) {
    ...
    function Hb(a) {
        ...
        do
            c = Gb.indexOf(a.charAt(i++)), d = Gb.indexOf(a.charAt(i++)), f = Gb.indexOf(a.charAt(i++)), g = Gb.indexOf(a.charAt(i++)), c = c << 2 | d >> 4, d = (d & 15) << 4 | f >> 2, e = (f & 3) << 6 | g, b += String.fromCharCode(c), 64 != f && (b += String.fromCharCode(d)), 64 != g && (b += String.fromCharCode(e));
        while (i < a.length);
        return b
    }
    var M = x.lang.bz;
    ...
    x.object.extend(I, {
            ...
            if (d.Bd == this.Fj.dq)
                ...
                if (d.Bd == this.Fj.rG) {
                    ...
                    e.EC == q && (e.EC = o, setTimeout(function () {
                            ...
                            e.EC = q;
                            e.Pd.Gn.length = 0;
                            /*0 == a.length ? e.ZK() : oa(e.kG.bQ + "&mod=" + a.join(","))*///注释掉
							//修改,加载本地模块
							if(a.length>0) {
        ...
        CZ: function (a, b) {
            ...
            c.Bd = this.Fj.dq;
            for (var e = 0, f = c.Tu.length; e < f; e++)
                c.Tu[e]();
            c.Tu.length = 0
        },
        hK: function (a, b) {
        ...
        extend: function (a) {
            if (a instanceof H) {
                ...
                if (!this.Le || this.Le > b)
                    this.Pl.lng = this.Le = b;
                if (!this.He || this.He < b)
                    this.yl.lng = this.He = b;
                if (!this.Xd || this.Xd > a)
                    this.Pl.lat = this.Xd = a;
                if (!this.Vd || this.Vd < a)
                    this.yl.lat = this.Vd = a
            }
        },
        NF: function () {
    ...
    x.extend(Fc.prototype, {
        ...
        Dm: function (a, b, c) {
            ...
            l = 0;
            for (d = this.Qc.length; l < d; l++)
                A = this.Qc[l][0], i = this.Qc[l][1], t = A * e + g[0] - c / 2, v = (-1 - i) * e + g[1] - c / 2, y = k + "_" + b + "_" + A + "_" + i + "_" + f, m = this.Tm[y], n = p, m ? (n = m.style, n.left = t + "px", n.top = v + "px", m.$e || this.qn.push([A, i, m])) : (0 < this.Ne.length ? (m = this.Ne.shift(), m.getContext("2d").clearRect(-c / 2, -c / 2, w, w), n = m.style) : (m = document.createElement("canvas"), n = m.style, n.position = "absolute", n.width = e + c + "px", n.height = e + c + "px", this.Rx() && (n.WebkitTransform = "scale(1.001)"), m.setAttribute("width", w), m.setAttribute("height", w), a.appendChild(m)), m.id = y, n.left = t + "px", n.top = v + "px", -1 < y.indexOf("bg") && (t = "#F3F1EC", this.map.C.Co && (t = this.map.C.Co), n.background = t ? t : ""), this.qn.push([A, i, m])), m.style.visibility = "";
            l = 0;
        ...
        Vg: function (a) {
            ...
            a = b.map.Wb();
            if (c instanceof bb)
                a && !c.Jm && (c.ra(this.map, this.ld), c.Jm = o);
        ...
        zg: function () {
            for (var a = this.Nm, b = 0, c = a.length; b < c; b++)
                a[b].remove();
            delete this.Rb;
            this.Nm = [];
            this.dj = this.ug = {};
    ...
    Me.prototype = {
        ...
        HQ: function (a) {
            if (a.DR === o)
                return this.PB = a.target, this.hx = Date.now(), o;
            if (this.PB && this.hx) {
                if (600 < Date.now() - this.hx)
                    return this.hx = this.PB = p, o
            } else {
            ...
            if ("select" != b && "input" != b && "textarea" != b)
                return a.stopImmediatePropagation ? a.stopImmediatePropagation() : a.oZ = o, a.stopPropagation(), a.preventDefault(), this.hx = this.PB = p, q
        },
        Tv: function (a) {
            ...
            if (this.enabled) {
                ...
                if (this.options.$x && (this.options.Vk ? (c = getComputedStyle(this.Pb, p)[le].replace(/[^0-9\-.,]/g, "").split(","), d =  + (c[12] || c[4]), c =  + (c[13] || c[5])) : (d = +getComputedStyle(this.Pb, p).left.replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Pb, p).top.replace(/[^0-9-]/g, "")), d != this.x || c != this.y))
                    this.options.Ai ? this.Yd(Ie) : Ke(this.XB), this.Aj = [], this.Cr(d, c), this.options.gy && this.options.gy.call(this);
                this.nw = this.x;
                this.ow = this.y;
                this.iu = this.x;
                this.ju = this.y;
        ...
        fv: function (a) {
            if (!(Ae && 0 !== a.touches.length)) {
                ...
                if (b.Yk)
                    d = b.scale * b.vp, d = Math.max(b.options.Xk, d), d = Math.min(b.options.bq, d), b.vp = d / b.scale, b.scale = d, b.x = b.iy - b.iy * b.vp + b.x, b.y = b.jy - b.jy * b.vp + b.y, b.Pb.style[oe] = "200ms", b.Pb.style[le] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + Le, b.Yk = q, b.refresh(), b.options.Ap && b.options.Ap.call(b, a);
                else {
                    if (b.oh) {
                        ...
                        if (Ae)
                            if (b.IK && b.options.zoom)
                                clearTimeout(b.IK), b.IK = p, b.options.Bp && b.options.Bp.call(b, a), b.zoom(b.rh, b.th, 1 == b.scale ? b.options.pW : 1), b.options.Ap && setTimeout(function () {
        ...
        ko: function (a) {
            ...
            if (b == this.x && c == this.y) {
                if (this.oh && (this.oh = q, this.options.gy && this.options.gy.call(this)), this.mi && this.options.Ix && ("webkit" == ee && (this.RL.style[we] = "300ms"), this.RL.style.opacity = "0"), this.Bi && this.options.Ix)
                    "webkit" == ee && (this.QO.style[we] = "300ms"), this.QO.style.opacity = "0"
            } else
        ...
        JU: function (a) {
            ...
            if ("zoom" == b.options.YO) {
                if (d = b.scale * Math.pow(2, 1 / 3 * (d ? d / Math.abs(d) : 0)), d < b.options.Xk && (d = b.options.Xk), d > b.options.bq && (d = b.options.bq), d != b.scale)
                    !b.Uy && b.options.Bp && b.options.Bp.call(b, a), b.Uy++, b.zoom(a.pageX, a.pageY, d, 400), setTimeout(function () {
                        b.Uy--;
        ...
        refresh: function () {
            ...
            if ("string" == typeof this.options.fu) {
                ...
                for (b = c.length; a < b; a++)
                    d = this.Zj(c[a]), d.left += this.XF, d.top += this.YF, this.Ue[a] = d.left < this.he ? this.he : d.left * this.scale, this.sf[a] = d.top < this.nd ? this.nd : d.top * this.scale
        ...
        scrollTo: function (a, b, c, d) {
            ...
            for (b = e.length; a < b; a++)
                e[a].qZ && (e[a].x = this.x - e[a].x, e[a].y = this.y - e[a].y), this.Aj.push({
                    x: e[a].x,
                    y: e[a].y,
                    time: e[a].time || 0
                });
    ...
    x.extend(Ne.prototype, {
        ...
        TV: function () {
            if (this.Ki)
                a = this.oL(this.Ni), this.vQ.innerHTML = a;
            else {
